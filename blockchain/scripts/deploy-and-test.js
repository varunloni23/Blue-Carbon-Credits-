...
async function deployAndTest() {
    ...
    try {
        ...
        // Add verificationOracle as authorized verifier
...
async function runComprehensiveTests(
    ...
    try {
        ...
        const projectTx = await projectRegistry.createProject(
            ...
            "22.25,-89.1", // GPS coordinates
            "Restoration of degraded mangrove ecosystems in the Sundarbans",
            "Community-led restoration with scientific monitoring"
        );
