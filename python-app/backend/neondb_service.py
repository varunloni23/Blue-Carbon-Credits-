...
class NeonDBService:
    def __init__(self):
        ...
        self.database_url = os.getenv(
            'DATABASE_URL', 
            'postgresql://neondb_owner:npg_0QRdU3ghjNwT@ep-orange-butterfly-admakbg6-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require'
        )
    ...
    def create_project(self, project_data: Dict) -> Optional[Dict]:
        ...
        query = '''
            INSERT INTO projects (project_id, title, description, location, ecosystem_type, 
                                area_hectares, carbon_estimate, blockchain_tx_hash, ipfs_hash, workflow_id, field_measurements)
    ...
    def update_project(self, project_id: str, update_data: Dict) -> Optional[Dict]:
        ...
        for key, value in update_data.items():
            if key in ['blockchain_tx_hash', 'ipfs_hash', 'workflow_id', 'status', 'area_hectares', 'carbon_estimate']:
